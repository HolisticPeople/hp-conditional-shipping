# hp conditional shipping - agent entry point (read this first)

You are in hp-conditional-shipping, part of the HolisticPeople platform. The source of truth is
